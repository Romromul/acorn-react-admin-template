...
const ServicesStorage = () => {
  const title = 'Storage';
  const description = 'Service Provider Storage';
            ...
            <Card.Body className="py-0 ps-4 pe-3 sh-14 sh-md-6">
              <Row className="g-0 h-100 align-content-center cursor-default">
                <Col xs="11" md="6" className="d-flex flex-column justify-content-center mb-1 mb-md-0 h-md-100 position-relative">
                  <NavLink to="/services/storage/folder" className="stretched-link body-link">
                    <CsLineIcons icon="folder" className="me-2 text-alternate" size="17" /> <span className="ps-1 align-middle">Products</span>
                  </NavLink>
                </Col>
                ...
                <Col md="3" className="d-flex flex-column justify-content-center order-3 ms-5 ms-md-0">
                  <div className="text-alternate">13.04.2021</div>
                </Col>
          ...
          <Card className={`mb-2 ${selectedItems.includes(2) && 'selected'}`}>
            <Card.Body className="py-0 ps-4 pe-3 sh-14 sh-md-6">
              <Row className="g-0 h-100 align-content-center cursor-default">
                <Col xs="11" md="6" className="d-flex flex-column justify-content-center mb-1 mb-md-0 h-md-100 position-relative">
                  <NavLink to="/services/storage/folder" className="stretched-link body-link">
                    <CsLineIcons icon="folder" className="me-2 text-alternate" size="17" /> <span className="ps-1 align-middle">Uploads</span>
                  </NavLink>
                </Col>
                <Col md="2" className="d-flex flex-column justify-content-center order-4 ms-5 ms-md-0">
                  <div className="text-alternate">—</div>
          ...
          <Card className={`mb-2 ${selectedItems.includes(3) && 'selected'}`}>
            <Card.Body className="py-0 ps-4 pe-3 sh-14 sh-md-6">
              <Row className="g-0 h-100 align-content-center cursor-default">
                <Col xs="11" md="6" className="d-flex flex-column justify-content-center mb-1 mb-md-0 h-md-100 position-relative">
                  <NavLink to="/services/storage/folder" className="stretched-link body-link">
                    <CsLineIcons icon="folder" className="me-2 text-alternate" size="17" /> <span className="ps-1 align-middle">Users</span>
                  </NavLink>
                </Col>
                <Col md="2" className="d-flex flex-column justify-content-center order-4 ms-5 ms-md-0">
                  <div className="text-alternate">—</div>
